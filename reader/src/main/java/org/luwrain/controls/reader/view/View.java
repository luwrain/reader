...
public class View
{
    ...
    public org.luwrain.controls.reader.view.Iterator getIterator()
    {
	return new Iterator(this);
    }

    public org.luwrain.controls.reader.view.Iterator getIterator(int startingIndex)
    {
	...
	final org.luwrain.controls.reader.view.Iterator it = getIterator();
